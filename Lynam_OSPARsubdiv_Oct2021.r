...
if(survey %in% c("GNSNetBT3", "GNSEngBT3", "GNSBelBT3")){
...
if(survey %in% c("CSFraOT4","CSEngBT1","CSEngBT3")){ #temporary for cefas bt - also attributes below
...
if(survey=="GNSBelBT3"){ surveyread<-"GNSIntOT1" } else { surveyread<-survey }
if(survey %in% c("CSEngBT1","CSEngBT3")){ surveyread<-"CSFraOT4" } else { surveyread<-survey } #temoprary for cefas bt
