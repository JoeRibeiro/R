...
CATCHABILITY_COR_WALKER<- F # read estimates from nsea paper for q
...
source("Lynam_INDfn_Nov2021.r") #Feb2019 now use QUAD to average biomass prior to indicators # Dec2017 update to include TAXA_GROUPINGS, Jan to calc Loo and Lm through Lynam_INDfn_Jan2018_Mtrait.r; Mar to include BX020_guilds # nov 2021 spit put occurrence for species
...
for(combrow in 1:nrow(survey_Q_C_S_combinations)){#16
  #### combrow<-9 #### combrow<-nrow(survey_Q_C_S_combinations) # combrow<-20#ibts q1
